...
// ButtonSupport intentionally removed from this view
      ...
      <div className="h-screen w-full flex flex-col justify-center items-center text-center gap-6 p-6">
        <div className="p-6 bg-neutral-50 rounded-xl">
          ...
          >
            ...
            />
            <circle cx={221.715} cy={108.007} r={26.239} className="fill-marigold-300" />
            <path
              className="fill-marigold-300"
              d="m143.516 494.591-12.478-3.977 9.402-50.025 18.418 5.87-15.342 48.132z"
            />
            <path
              className="fill-stout-800"
        ...
        <p className="text-crimson-600">{error?.message}</p>
