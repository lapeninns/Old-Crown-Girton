          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 md:grid-cols-3">
              <div className="p-6 rounded-lg border border-gray-200 bg-neutral/40">
                ...
                <Link href="/events" className="text-accent-900 font-semibold hover:underline">View Events →</Link>
              </div>
              <div className="p-6 rounded-lg border border-gray-200 bg-neutral/40">
                ...
                <Link href="/about" className="text-accent-900 font-semibold hover:underline">Explore Heritage →</Link>
              </div>
              <div className="p-6 rounded-lg border border-gray-200 bg-neutral/40">
                ...
                <Link href="/contact" className="text-accent-900 font-semibold hover:underline">Enquire →</Link>
              </div>
            </div>
          </div>
        </section>
  ...
  <section className="py-16 bg-accent/10">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/menu" style={{ backgroundColor: 'var(--color-accent-950)' }} className="bg-accent-950 hover:bg-accent-950 text-white font-bold py-3 px-6 rounded-lg text-sm md:text-base">{labelViewMenu}</Link>
