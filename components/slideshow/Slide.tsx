...
const Slide: React.FC<{ slide: SlideType; active?: boolean }> = ({ slide }) => {
  return (
    <section className="relative h-[60vh] sm:h-[65vh] md:h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 text-sm md:text-base text-white/85 mb-8 sm:mb-10 max-w-3xl mx-auto px-2 sm:px-0">
            {(slide.badges || []).map((b) => (
