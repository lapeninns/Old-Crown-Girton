  ...
  return (
    <section className="py-8 bg-gradient-to-br from-stout-800 to-stout-800/80">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-sm sm:text-base text-neutral-200 mb-4">Curated menu — quick to scan. Book or call for takeaway.</p>
        <div className="flex items-center justify-center gap-3">
          <a href="https://www.nabatable.com/restaurants/the-old-crown-girton/book" target="_blank" rel="noopener noreferrer" className="bg-accent text-white font-semibold py-2 px-4 rounded-md text-sm">
            {labelBookOnline}
          </a>
