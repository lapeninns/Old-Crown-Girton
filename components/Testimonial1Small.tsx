  ...
  return (
    <section className="bg-white">
      <div className="space-y-6 md:space-y-8 max-w-lg mx-auto px-8 py-16 md:py-32">
        <div className="bg-white rounded-2xl shadow-xl border border-accent-200/20 p-8 space-y-6 md:space-y-8">
          ...
          <div className="text-base leading-relaxed space-y-2 max-w-md mx-auto text-center">
            <p className="text-neutral-700">
              <span className="bg-accent-500/25 px-1.5 rounded">
          ...
          <div className="flex justify-center items-center gap-3 md:gap-4">
            <Image
              className="w-10 h-10 md:w-12 md:h-12 rounded-full object-cover border-2 border-accent-200"
            ...
            />
            <div>
              <p className="font-semibold text-brand-700">Someone Nice</p>
              <p className="text-brand-600 text-sm">23.1K followers on 𝕏</p>
            </div>
          </div>
        </div>
      </div>
